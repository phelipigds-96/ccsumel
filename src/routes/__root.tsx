...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Gestão de campanhas, ofertas e verbas." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Central de Campanhas Sumel" },
      { property: "og:description", content: "Gestão de campanhas, ofertas e verbas." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Central de Campanhas Sumel" },
